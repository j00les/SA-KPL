...
import { QualifyingSession } from '@/lib/types';
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="text-left text-gray-500 uppercase tracking-wide">
                ...
                <th className="pb-1.5 font-medium text-right">Best Lap</th>
              </tr>
            </thead>
            <tbody>
              {sorted.map((r) => (
                <tr key={r.driverId} className="border-t border-[#2A2A2A]">
                  ...
                  <td className="py-1.5 pr-2 font-medium text-gray-300 truncate max-w-[160px]">
                    {r.driverName}
                  </td>
